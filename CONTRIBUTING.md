...
* You can contribute to cdp4j by opening a Pull Request.
* In most cases, pull requests for bug fixes and new features should be based on the <code>main</code> branch.
