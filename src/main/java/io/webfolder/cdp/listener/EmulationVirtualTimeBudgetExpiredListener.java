 ...
 */
@FunctionalInterface
public interface EmulationVirtualTimeBudgetExpiredListener extends AbstractListener<VirtualTimeBudgetExpired> {

    void onEvent(VirtualTimeBudgetExpired value);
}